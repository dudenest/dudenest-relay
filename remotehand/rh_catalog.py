...
CATALOG: tuple[Screen, ...] = (
    ...
    Screen("chrome_welcome", PageState.WELCOME,
           (r"welcome to google chrome", r"help make chrome better", r"set google chrome as my default browser"),
           action="auto_click", notes="first-run interstitial: untick stats/default checkbox if visible, then OK"),
